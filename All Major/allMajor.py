...
all_majors_list = (list(sorted(set(df['Major Beginning of Semester']))))

all_majors_list.append('Others')

print(all_majors_list)




# df = pd.DataFrame(np.array(all_majors_list), columns = list("a"))
# print(df)
#
# writer = ExcelWriter('AllMajorsEnrollementData.xlsx')
